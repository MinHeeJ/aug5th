...
public record SystemConfigurationSearchCondition(
    int page,
    int size,
    String sort,
    String q,
    ...
    public static SystemConfigurationSearchCondition of(Integer page, Integer size, String sort, String q, String filter) {
        int normalizedPage = page == null || page < 1 ? 1 : page;
        int normalizedSize = size == null || (size != 20 && size != 50 && size != 100) ? 20 : size;
        return new SystemConfigurationSearchCondition(
            normalizedPage,
            normalizedSize,
            sort,
            blankToNull(q),
